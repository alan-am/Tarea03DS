...
public class TravelEaseReservaBuilderTestPlan {

    // Metodo: reset() | Entrada: ninguno | Salida esperada: reserva no nula
    @Test
    ...
    // Metodo: buildVuelo(Vuelo) | Entrada: vuelo con numero V1 | Salida esperada: reserva.vuelo = vuelo
    @Test
    ...
    // Metodo: buildAlquilerVehiculo(Vehiculo) | Entrada: un vehiculo | Salida esperada: lista con tamaño 1
    @Test
    ...
    // Metodo: buildPrecio() | Entrada: boletos=[50,70], vehiculos=[120] | Salida esperada: precio=240.0
    @Test
